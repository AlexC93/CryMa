...
public class Cryptocurrency {
	...
	private Map<Date, Long> historicalValues;
	...
	public Map<Date, Long> getHistoricalValues() {
		return historicalValues;
	}

	public void setHistoricalValues(Map<Date, Long> historicalValues) {
	...
	public String toString() {
		...
		output.append("prices = ").append(historicalValues).append("\n");
